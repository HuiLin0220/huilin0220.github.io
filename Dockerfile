...
RUN apt-get update -y && \
    ...
    locales git build-essential zlib1g-dev libssl-dev libreadline-dev libyaml-dev \
    libxml2-dev libxslt1-dev libcurl4-openssl-dev libffi-dev imagemagick python3-pip && \
    apt-get clean && \
